...
struct InformeTrimestralSO: View {
...
struct InformeTrimestralSO_Previews: PreviewProvider {
    static var previews: some View {
        InformeTrimestralSO(cumplimiento: "No Cumplió", observacion: "", anio: 2020,tipo: "subsidio_ordinario")
    }
}
