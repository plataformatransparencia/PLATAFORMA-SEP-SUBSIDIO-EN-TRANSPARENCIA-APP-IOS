...
struct InformeTrimestralRC: View {
                        ...
                        HStack{
                            VStack{
                                HStack{
                                    ...
                                    Spacer()
                                    Text("Informe Trimestral de Rendición de Cuentas")
...
struct InformeTrimestralRC_Previews: PreviewProvider {
    static var previews: some View {
        InformeTrimestralRC(cumplimiento: "Cumplió", observacion: "Esta es una observación", anio: 2020,tipo: "subsidio_ordinario")
    }
}
